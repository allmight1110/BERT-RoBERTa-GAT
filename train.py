...
with open('E:/文本分类/text_gcn.pytorch-master/data/corpus/' + dataset + '_vocab.txt', 'r',encoding='utf-8') as f:
    words = f.readlines()
...
word_embeddings_str = '\n'.join(word_vectors)
with open('E:/文本分类/text_gcn.pytorch-master/data/' + dataset + '_word_vectors.txt', 'w') as f:
...
doc_embeddings_str = '\n'.join(doc_vectors)
with open('E:/文本分类/text_gcn.pytorch-master/data/' + dataset + '_doc_vectors.txt', 'w') as f:
