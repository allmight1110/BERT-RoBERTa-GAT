...
with open('E:/文本分类/text_gcn.pytorch-master/data/corpus/' + dataset + '.txt', 'rb') as f:
...
for doc_content in doc_content_list:
    ...
    words = jieba.lcut(temp, cut_all=True, HMM=True)
...
with open('E:/文本分类/text_gcn.pytorch-master/data/corpus/' + dataset + '.clean.txt', 'w',encoding='utf-8') as f:
